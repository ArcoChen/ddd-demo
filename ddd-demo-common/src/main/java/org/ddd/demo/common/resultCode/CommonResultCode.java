...
public class CommonResultCode extends ResultCode {
    ...
    public static final CommonResultCode DATA_EXIST = new CommonResultCode(420001, "data exist");
    public static final CommonResultCode DATA_NOT_EXISTS = new CommonResultCode(420002, "data not exist");
    public static final CommonResultCode DATA_OPERATION_ERROR = new CommonResultCode(420003, "data operation error");
